...
int main (){
	...
	O algoritmo deve solicitar ao usuário que ele digite o valor
	que deseja sacar. Esse valor deve ser entre 2 e 2.000 reais.
	
	Após isso, imprima na tela quantas notas de 2, 5, 10, 20, 50, 100 e 200 reais 
	...
	*/
	...
	cout << "Digite o valor que deseja sacar (Valores disponíveis: R$ 2 a 2.000 reais): \n";
	cin >> valor;
